...
exports.doCharge = function(req, res, next) {
  ...
  var chargeToken = 'Basic ' + new Buffer('SB-Mid-server-Zbsb-T_jALFkRUFnHZadfbd2').toString('base64'); // Dummy Charge Token
...
exports.doChargeProd = function(req, res, next) {
  ...
  var chargeToken = 'Basic ' + new Buffer('Mid-server-sB9l9MFA1Y4XsaY-ZBsAkqGS').toString('base64');
